...
class LLMS_Integration_Buddypress extends LLMS_Abstract_Integration {
	...
	public function set_title_and_description() {
		...
		$this->description = __( 'Добавляет сведения VibeLMS в профили пользователей и включает ограничения доступа для активности, групп и каталогов участников.', 'lifterlms' );
	}
