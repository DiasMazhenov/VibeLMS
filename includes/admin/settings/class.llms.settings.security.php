	...
	public function get_settings() {
		$account_settings = array(
			...
			array(
				...
				'desc'     => __( 'Requires reCAPTCHA v3 keys.', 'lifterlms' ),
			...
			array(
				...
				'desc'              => __( 'The minimum score required for reCAPTCHA validation, from 1-10. Google recommends 5 as a default.', 'lifterlms' ),
			...
			array(
				...
				'desc'     => __( 'Requires Cloudflare Turnstile keys.', 'lifterlms' ),
