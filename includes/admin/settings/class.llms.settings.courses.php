		...
		$course = apply_filters(
			...
			array(
				...
				array(
					...
					'desc'              => __( 'This page will be shown to students when they complete the course.', 'lifterlms' ),
				...
				array(
					...
					'desc'              => __( 'This page is where your visitors will find a list of all your available courses.', 'lifterlms' ),
