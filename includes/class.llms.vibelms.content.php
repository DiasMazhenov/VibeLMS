...
class LLMS_VibeLMS_Content {
	...
	/**
	 * Localize static Elementor copy on the active Kazakh surface.
	 *
	 * Elementor stores native headings and text widgets as one document. This
	 * keeps that document editable while applying the project's active-language
	 * copy at render time; reusable language-aware widgets remain available for
	 * project-specific content that should not use these defaults.
	 *
	 * @param string $content Rendered post content.
	 * @return string
	 */
	public function localize_elementor_content( $content ) {
	...
	private function get_kazakh_elementor_replacements( $content = '' ) {
		return apply_filters(
			...
			array(
				...
				'Посмотрите обучающие видео и ознакомьтесь со стандартами работы.' => 'Оқу бейнелерін көріп, жұмыс стандарттарымен танысыңыз.',
				'Изучение' => 'Оқу',
				'Материалы курса' => 'Курс материалдары',
				'02 · Проверьте себя' => '02 · Өзіңізді тексеріңіз',
				'Ответьте на вопросы итогового теста по материалам курса.' => 'Курс материалдары бойынша қорытынды тест сұрақтарына жауап беріңіз.',
				'Проверка знаний' => 'Білімді тексеру',
				'Итоговый тест' => 'Қорытынды тест',
				'Начать обучение' => 'Оқуды бастау',
				'Обучающие видео' => 'Оқыту бейнелері',
				'Три коротких ролика помогут быстро пройти основные темы курса. Видео можно смотреть с компьютера, планшета или телефона.' => 'Үш қысқа ролик курс тақырыптарын жылдам меңгеруге көмектеседі. Бейнелерді компьютерден, планшеттен немесе телефоннан көре аласыз.',
				'Введение в курс' => 'Курсқа кіріспе',
				'Стандарты работы' => 'Жұмыс стандарттары',
				'Итоговая подготовка' => 'Қорытынды дайындық',
				'Стандарты и документы' => 'Стандарттар мен құжаттар',
				'В этом разделе будут доступны регламенты, инструкции и технологические карты на выбранном языке.' => 'Бұл бөлімде таңдалған тілдегі регламенттер, нұсқаулықтар және технологиялық карталар қолжетімді болады.',
				'Регламенты и инструкции' => 'Регламенттер мен нұсқаулықтар',
				'PDF и DOCX-файлы появятся после загрузки администратором.' => 'PDF және DOCX файлдары әкімші жүктегеннен кейін пайда болады.',
				'Технологические карты' => 'Технологиялық карталар',
				'Материалы выдаются только авторизованным участникам обучения.' => 'Материалдар тек оқуға тіркелген авторизацияланған қатысушыларға беріледі.',
			),
			$content
		);
	}
